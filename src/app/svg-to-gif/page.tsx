...
const config: LandingConfig = {
  ...
  faqs: [
    ['How do I convert an SVG to an animated GIF?', 'Upload your SVG to Reframe, animate it with an AI prompt or a preset, set your quality and frame rate, then export to GIF. It all happens in your browser. Free GIF exports carry a small Reframe watermark, which a credit or a Pro plan removes.'],
    ...
    ['Is the SVG to GIF converter free?', 'Yes, and no account is required. GIF exports carry a small Reframe watermark on the free tier. Spending one AI credit removes it from an export, and Pro removes it from every export.'],
  ],
