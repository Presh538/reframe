...
const config: LandingConfig = {
  ...
  description:
    'Animate any SVG with AI for free. Describe the motion in plain English and Reframe applies it instantly — then export to GIF, WebM, or Lottie. No timeline, no code, no After Effects.',
  ...
  steps: [
    ...
    ['Export or share', 'Export to GIF (with transparent background), WebM, or Lottie JSON — or copy a shareable preview link.'],
  ],
